            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control summernote" id="body" name="body" rows="6" required>{{ $oldBody }}</textarea>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    <div class="col-md-12 mb-3">
                        ...
                        <div id="hidden-tags-container">
                            {{-- Hidden inputs untuk menyimpan tag akan ditambahkan oleh JS --}}
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const initialTags = @json($oldTags);
