        ...
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="card kpi-card bg-approved">
                <div class="card-body">
                    ...
                    <h2 class="kpi-value">{{ $stats['approved'] }}</h2>
        ...
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="card kpi-card bg-expired">
                <div class="card-body">
                    ...
                    <h2 class="kpi-value">{{ $stats['expired'] }}</h2>
                                ...
                                <li class="list-group-item px-0 py-2 border-bottom">
                                    <a href="{{ route('work-units.spo.show', $spo->id) }}" class="d-flex justify-content-between align-items-center text-decoration-none">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="fw-medium text-dark">{{ $spo->document_title }}</span>
                                                <span class="text-muted ms-2">({{ $spo->document_number }})</span>
                                                @if($spo->file_path)
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    @if($topWorkUnits->count() > 0)
                        <ul class="list-group">
                            @foreach($topWorkUnits as $unit)
                                <li class="list-group-item d-flex justify-content-between align-items-center hover-effect">
                                    <div>
                                        <i class="fas fa-building me-2 text-info"></i>
                                        {{ $unit->unit_name }}
                                    </div>
                                    <span class="badge bg-info rounded-pill">{{ $unit->spo_count }}</span>
                                </li>
                            @endforeach
                        </ul>
                    @else
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="small text-muted">
                                                    <i class="far fa-calendar-alt me-1"></i> Review: {{ $spo->next_review ? \Carbon\Carbon::parse($spo->next_review)->format('d M Y') : '-' }}
                                                </div>
                                            </div>
                                        </div>
                                        <i class="fas fa-chevron-right text-muted"></i>
