        ...
        <div class="col-md-4 mb-3">
            <div class="card dashboard-card border-0 shadow-sm" style="border-left-color:#0ea5e9;">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('superadmin.tenants.index') }}" class="btn btn-outline-primary">Kelola</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-3">
            <div class="card dashboard-card border-0 shadow-sm" style="border-left-color:#22c55e;">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('superadmin.modules.index') }}" class="btn btn-outline-primary">Kelola</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-3">
            <div class="card dashboard-card border-0 shadow-sm" style="border-left-color:#6366F1;">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('superadmin.users.index') }}" class="btn btn-outline-primary">Kelola</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body d-flex flex-wrap gap-2">
                    <a href="{{ route('superadmin.tenants.create') }}" class="btn btn-primary"><i class="fas fa-plus me-1"></i> Tambah Tenant</a>
                    <a href="{{ route('superadmin.modules.index') }}" class="btn btn-outline-primary"><i class="fas fa-grid me-1"></i> Kelola Modul</a>
                    <a href="{{ route('superadmin.users.index') }}" class="btn btn-outline-primary"><i class="fas fa-users me-1"></i> Kelola Pengguna</a>
                </div>
            </div>
        </div>
    </div>
