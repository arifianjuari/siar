...
<div class="sidebar-wrapper">
    ...
    <div class="sidebar-content">
        ...
        @if($isSuperAdmin)
            ...
            <a href="{{ route('superadmin.tenants.index') }}" class="nav-link sidebar-link {{ request()->routeIs('superadmin.tenants.*') ? 'active' : '' }} mb-2">
                <div class="d-flex align-items-center">
                    <div class="icon-sidebar">
            ...
            <a href="{{ route('superadmin.modules.index') }}" class="nav-link sidebar-link {{ request()->routeIs('superadmin.modules.*') ? 'active' : '' }} mb-2">
                <div class="d-flex align-items-center">
                    <div class="icon-sidebar">
            ...
            <a href="{{ route('superadmin.users.index') }}" class="nav-link {{ request()->routeIs('superadmin.users.*') ? 'active' : '' }} mb-2">
                <div class="d-flex align-items-center">
                    <div class="icon-sidebar">
        ...
        <!-- Manajemen SPO -->
        <a href="{{ url('work-units/spo/dashboard') }}" 
           class="nav-link sidebar-link {{ request()->is('work-units/spo*') || request()->routeIs('work-units.spo.*') ? 'active' : '' }} mb-2">
            <div class="d-flex align-items-center">
                <div class="icon-sidebar">
