            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form id="permission-form" action="{{ route('superadmin.tenants.roles.permissions.update', [$tenant, $role]) }}" method="POST">
                        ...
                        <!-- Debug fields -->
                        <input type="hidden" name="debug_form_action" value="{{ route('superadmin.tenants.roles.permissions.update', [$tenant, $role]) }}">
                        <input type="hidden" name="debug_tenant_id" value="{{ $tenant->id }}">
                        <input type="hidden" name="debug_role_id" value="{{ $role->id }}">
                                            ...
                                            <div class="d-flex flex-wrap gap-3">
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input view-permission" 
                                                        ...
                                                        value="1"
                                                        {{ isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_view ? 'checked' : '' }}
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input other-permission" 
                                                        ...
                                                        value="1"
                                                        {{ isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_create ? 'checked' : '' }}
                                                        {{ isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_view ? '' : 'disabled' }}
                                                        data-module-id="{{ $module->id }}">
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input other-permission" 
                                                        ...
                                                        value="1"
                                                        {{ isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_edit ? 'checked' : '' }}
                                                        {{ isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_view ? '' : 'disabled' }}
                                                        data-module-id="{{ $module->id }}">
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input other-permission" 
                                                        ...
                                                        value="1"
                                                        {{ isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_delete ? 'checked' : '' }}
                                                        {{ isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_view ? '' : 'disabled' }}
                                                        data-module-id="{{ $module->id }}">
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input other-permission" 
                                                        ...
                                                        value="1"
                                                        {{ isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_export ? 'checked' : '' }}
                                                        {{ isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_view ? '' : 'disabled' }}
                                                        data-module-id="{{ $module->id }}">
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input other-permission" 
                                                        ...
                                                        value="1"
                                                        {{ isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_import ? 'checked' : '' }}
                                                        {{ isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_view ? '' : 'disabled' }}
                                                        data-module-id="{{ $module->id }}">
