...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\PreventMigrationInProduction::class,
    ];
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            // Tenant middleware dinonaktifkan untuk mengatasi masalah login
            // \App\Http\Middleware\TenantMiddleware::class, // DINONAKTIFKAN!
        ],
    ...
    protected $routeMiddleware = [
        ...
        'module' => \App\Http\Middleware\CheckModuleAccess::class,
        'tenant.resolve' => \App\Http\Middleware\ResolveTenantByDomain::class,
        'check.permission' => \App\Http\Middleware\CheckPermissionMiddleware::class,
    ];
}
