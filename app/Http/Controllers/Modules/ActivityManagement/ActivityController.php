...
class ActivityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('modules.activity_management.index', compact('activities', 'workUnits', 'categories'));
    }
    ...
    public function create()
    {
        ...
        return view('modules.activity_management.create', compact('parentActivities', 'workUnits', 'users'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('modules.activity_management.show', compact('activity'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('modules.activity_management.edit', compact('activity', 'parentActivities', 'workUnits'));
    }
