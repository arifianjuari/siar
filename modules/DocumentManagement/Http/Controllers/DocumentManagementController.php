...
class DocumentManagementController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('document-management::dashboard', compact(
            'stats',
            'latestDocuments',
            'categories',
            'moduleCategories',
    ...
    public function documentsByTag(Request $request, $slug)
    {
        ...
        return view('document-management::documents-by-tag', compact('tag', 'combinedDocuments', 'selectedModule'));
    }
    ...
    public function documentsByType($type)
    {
        ...
        return view('document-management::documents-by-type', [
