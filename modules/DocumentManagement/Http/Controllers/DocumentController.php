...
class DocumentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('document-management::documents.index', compact('documents', 'categories', 'availableTags'));
    }
    ...
    public function create()
    {
        ...
        return view('document-management::documents.create', compact('documents', 'documentTypes', 'documentScopes'));
    }
    ...
    public function show(Document $document)
    {
        ...
        return view('document-management::documents.show', compact('document'));
    }
    ...
    public function edit(Document $document)
    {
        ...
        return view('document-management::documents.edit', compact('document', 'documents', 'documentTypes', 'documentScopes'));
    }
