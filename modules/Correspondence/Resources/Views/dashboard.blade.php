...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('modules.correspondence.letters.index') }}" class="btn btn-primary btn-sm shadow-sm me-2">
                <i class="fas fa-list fa-sm text-white-50"></i> Lihat Semua Surat
            </a>
            @if(hasModulePermission('correspondence-management', 'can_create'))
            <a href="{{ route('modules.correspondence.letters.create') }}" class="btn btn-success btn-sm shadow-sm">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="{{ route('modules.correspondence.letters.index') }}" class="btn btn-primary btn-icon-split mb-2 w-100">
                    ...
                    @if(hasModulePermission('correspondence-management', 'can_create'))
                    <a href="{{ route('modules.correspondence.letters.create') }}" class="btn btn-success btn-icon-split mb-2 w-100">
                        <span class="icon text-white-50">
