...
class CorrespondenceController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $thisMonth = Correspondence::where('tenant_id', $tenant_id)
            ->whereYear('created_at', Carbon::now()->year)
            ->whereMonth('created_at', Carbon::now()->month)
            ->count();
        
        // Hitung draft (placeholder - sesuaikan dengan status field jika ada)
        $draft = 0; // Jika ada field status, gunakan: ->where('status', 'draft')->count();
        
        // Hitung pending review (placeholder)
        $pendingReview = 0; // Sesuaikan dengan field yang ada
        ...
        $chartDataStatus = [
            'labels' => ['Regulasi', 'Bukti'],
            'data' => [$totalRegulasi, $totalBukti],
            'colors' => ['#4e73df', '#1cc88a']
        ];
        
        // Ambil surat terbaru untuk aktivitas terbaru
        $recentLetters = Correspondence::where('tenant_id', $tenant_id)
            ->orderBy('created_at', 'desc')
            ->limit(5)
            ->get();

        return view('correspondence::dashboard', compact('stats', 'chartDataMonthly', 'chartDataStatus', 'recentLetters'));
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('correspondence::letters.index', compact('correspondences'));
    }
    ...
    public function create()
    {
        ...
        return view('correspondence::letters.create', compact('tags', 'users'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('correspondence::letters.show', compact('correspondence'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('correspondence::letters.edit', compact('correspondence', 'tags', 'users'));
    }
    ...
    public function generateQrBase64(string $id)
    {
        ...
        return view('correspondence::letters.qr-embed', [
            'dataUri' => $dataUri,
    ...
    public function exportPdf(string $id)
    {
        ...
        $html = view('correspondence::letters.pdf', compact('correspondence', 'qrCodeDataUri'))->render();
...
return $dompdf->stream($fileName);
    ...
    public function exportWord(string $id)
    {
        ...
        // Generate view
        $view = view('correspondence::letters.word', compact('correspondence'))->render();
