...
namespace Modules\PerformanceManagement\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Facades\Route;

class PerformanceManagementServiceProvider extends ServiceProvider
{
    /**
     * Module namespace
     * @var string
     */
    protected $moduleName = 'PerformanceManagement';
    
    /**
     * Module lowercase name
     * @var string
     */
    protected $moduleNameLower = 'performance-management';
