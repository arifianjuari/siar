...
use Modules\RiskManagement\Models\RiskAnalysis;
...
class RiskAnalysisController extends Controller
{
    ...
    public function create(Request $request, $reportId)
    {
        ...
        return view('risk-management::risk-analysis.create', compact('report', 'contributorFactors'));
    }
    ...
    public function show($reportId, $id)
    {
        ...
        return view('risk-management::risk-analysis.show', compact('report', 'analysis'));
    }
