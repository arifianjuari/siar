...
@section('title', ' | Edit Analisis Risiko')
...
<div class="container-fluid py-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('modules.risk-management.risk-reports.show', $report->id) }}">{{ Str::limit($report->document_title, 30) }}</a></li>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('modules.risk-management.risk-analysis.show', [$report->id, $analysis->id]) }}" class="btn btn-outline-secondary">
                <i class="fas fa-eye me-2"></i> Lihat Analisis
            </a>
            <a href="{{ route('modules.risk-management.risk-reports.show', $report->id) }}" class="btn btn-outline-secondary ms-2">
    ...
    <form action="{{ route('modules.risk-management.risk-analysis.update', [$report->id, $analysis->id]) }}" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea id="direct_cause" name="direct_cause" class="form-control @error('direct_cause') is-invalid @enderror" required>{{ old('direct_cause', $analysis->direct_cause) }}</textarea>
                            @error('direct_cause')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="root_cause" name="root_cause" class="form-control @error('root_cause') is-invalid @enderror" required>{{ old('root_cause', $analysis->root_cause) }}</textarea>
                            @error('root_cause')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="factor-option form-check">
                                        <input type="checkbox" class="form-check-input" 
                                               ...
                                               value="{{ $key }}"
                                               {{ isset($analysis->contributor_factors[$category]) && in_array($key, $analysis->contributor_factors[$category]) ? 'checked' : '' }}>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea id="recommendation_short" name="recommendation_short" class="form-control @error('recommendation_short') is-invalid @enderror" required>{{ old('recommendation_short', $analysis->recommendation_short) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="recommendation_medium" name="recommendation_medium" class="form-control @error('recommendation_medium') is-invalid @enderror">{{ old('recommendation_medium', $analysis->recommendation_medium) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="recommendation_long" name="recommendation_long" class="form-control @error('recommendation_long') is-invalid @enderror">{{ old('recommendation_long', $analysis->recommendation_long) }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select id="analysis_status" name="analysis_status" class="form-select @error('analysis_status') is-invalid @enderror" required>
                                <option value="draft" {{ old('analysis_status', $analysis->analysis_status) == 'draft' ? 'selected' : '' }}>Draft</option>
                                <option value="in_progress" {{ old('analysis_status', $analysis->analysis_status) == 'in_progress' || old('analysis_status', $analysis->analysis_status) == 'reviewed' ? 'selected' : '' }}>Ditinjau</option>
                                <option value="completed" {{ old('analysis_status', $analysis->analysis_status) == 'completed' ? 'selected' : '' }}>Selesai</option>
                            </select>
                        ...
                        <div class="mb-3">
                            <div class="form-text text-muted mb-3">
                                <i class="fas fa-info-circle me-1"></i> Analisis terakhir diperbarui pada {{ $analysis->updated_at->format('d M Y, H:i') }}
                                @if($analysis->analyst)
                                 oleh {{ $analysis->analyst->name }}
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('modules.risk-management.risk-analysis.show', [$report->id, $analysis->id]) }}" class="btn btn-outline-secondary w-50">
                                <i class="fas fa-eye me-1"></i> Lihat
                            </a>
                            <a href="{{ route('modules.risk-management.risk-reports.show', $report->id) }}" class="btn btn-outline-secondary w-50">
                                Batal
                            </a>
                        </div>
                        ...
                        <div class="mt-3">
                            <a href="{{ route('modules.risk-management.risk-analysis.qr-code', [$report->id, $analysis->id]) }}" class="btn btn-dark w-100" target="_blank">
