...
use Modules\ActivityManagement\Models\ActivityComment;
use Modules\ActivityManagement\Models\ActivityStatusLog;
    ...
    public function index(Request $request, string $activityUuid)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'status' => 'success',
                'data' => $comments,
                'html' => view('activity-management::comments.partials.comment_list', compact('comments', 'activity'))->render()
            ]);
        }

        return view('activity-management::comments.index', compact('activity', 'comments'));
    }
        ...
        try {
            ...
            if ($request->parent_id) {
                ...
                return response()->json([
                    ...
                    'html' => view('activity-management::comments.partials.reply_item', compact('comment'))->render()
                ]);
            }
            ...
            return response()->json([
                ...
                'data' => $comment,
                'html' => view('activity-management::comments.partials.comment_item', compact('comment'))->render()
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => 'error',
