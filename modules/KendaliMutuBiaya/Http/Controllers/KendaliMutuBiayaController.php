...
namespace Modules\KendaliMutuBiaya\Http\Controllers;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Modules\KendaliMutuBiaya\Models\ClinicalPathway;
use Modules\KendaliMutuBiaya\Models\CpStep;
use Modules\KendaliMutuBiaya\Models\CpTariff;
use Modules\KendaliMutuBiaya\Models\CpEvaluation;
use Modules\KendaliMutuBiaya\Models\CpEvaluationStep;
use Modules\KendaliMutuBiaya\Models\CpEvaluationAdditionalStep;
...
class KendaliMutuBiayaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kendali-mutu-biaya::index', compact('clinicalPathways'));
    }
    ...
    {
        return view('kendali-mutu-biaya::create');
    }
    ...
    public function show($id)
    {
        ...
        return view('kendali-mutu-biaya::show', compact('clinicalPathway'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('kendali-mutu-biaya::edit', compact('clinicalPathway'));
    }
    ...
    public function manageTariffs($id)
    {
        ...
        return view('kendali-mutu-biaya::tariffs', compact('clinicalPathway'));
    }
    ...
    public function evaluateCP($id)
    {
        ...
        return view('kendali-mutu-biaya::evaluate', compact('clinicalPathway'));
    }
    ...
    public function showEvaluation($id)
    {
        ...
        return view('kendali-mutu-biaya::show-evaluation', compact('evaluation'));
    }
    ...
    public function rekapEvaluation(Request $request)
    {
        ...
        return view('kendali-mutu-biaya::rekap', compact(
            'evaluations',
            'clinicalPathways',
            'startDate',
            'endDate',
