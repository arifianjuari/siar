...
<head>
    ...
    <title><?php echo e(config('app.name', 'SIAR')); ?> | Superadmin <?php echo $__env->yieldContent('title'); ?></title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('superadmin.dashboard')); ?>">
                <span class="text-primary me-1"><?php echo e(config('app.name', 'SIAR')); ?></span> 
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a href="<?php echo e(route('dashboard')); ?>" class="nav-link d-flex align-items-center">
        ...
        <div class="sidebar">
            <div class="py-4">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('superadmin.modules.*') ? 'active' : ''); ?>" href="<?php echo e(route('superadmin.modules.index')); ?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('superadmin.statistics') ? 'active' : ''); ?>" href="<?php echo e(route('superadmin.statistics')); ?>">
            ...
            <div class="sidebar-footer">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'SIAR')); ?></p>
            </div>
        </div>
...
</html> <?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/MYDEV/siar/resources/views/superadmin/layout.blade.php ENDPATH**/ ?>