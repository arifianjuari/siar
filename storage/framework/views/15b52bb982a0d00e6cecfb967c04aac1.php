                            ...
                            <div class="card h-100 border-0 shadow-sm module-card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div>
                                            <h5 class="mb-0"><?php echo e($module->name); ?></h5>
                                            <p class="text-muted mb-0 small"><?php echo e($module->description); ?></p>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                        <a href="<?php echo e(url('modules/' . $module->slug)); ?>" class="btn btn-primary w-100">
...
</div><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/MYDEV/siar/resources/views/layouts/partials/dashboard_widgets.blade.php ENDPATH**/ ?>