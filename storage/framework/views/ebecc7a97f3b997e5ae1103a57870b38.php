...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <?php $__currentLoopData = $workUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($unit->id); ?>" 
                                                    ...
                                                    <?php echo e(old('work_unit_id') == $unit->id ? 'selected' : ''); ?>>
                                                <?php echo e($unit->unit_name); ?> <?php echo e($unit->unit_code ? '('.$unit->unit_code.')' : ''); ?>

                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <input type="hidden" name="reporter_unit" id="reporter_unit_name" value="<?php echo e(old('reporter_unit')); ?>">
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/01 PAPA/05 DEVELOPMENT/siar/resources/views/modules/RiskManagement/risk-reports/create.blade.php ENDPATH**/ ?>