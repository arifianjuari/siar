...
unset($__errorArgs, $__bag); ?>" id="letter_head" name="letter_head" rows="4"><?php echo e(old('letter_head', $tenant->letter_head)); ?></textarea>
                        <div class="form-text">Masukkan teks kop surat yang akan digunakan pada dokumen resmi. Contoh: KEPOLISIAN DAERAH JAWA TIMUR</div>
