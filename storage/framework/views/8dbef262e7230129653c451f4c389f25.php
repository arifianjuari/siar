            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="document_number" name="document_number" value="<?php echo e(old('document_number')); ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control" id="confidentiality_level" name="confidentiality_level" required>
                            ...
                            <option value="Internal" <?php echo e(old('confidentiality_level') == 'Internal' ? 'selected' : ''); ?>>Internal</option>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" id="body" name="body" rows="6" required><?php echo e(old('body')); ?></textarea>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tags[]" value="<?php echo e($tag->slug); ?>" id="tag_<?php echo e($tag->id); ?>" 
                                        <?php echo e(in_array($tag->slug, old('tags', [])) ? 'checked' : ''); ?>>
