        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <h2 class="mb-0">Edit Role: <?php echo e($role->name); ?></h2>
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('superadmin.tenants.roles.update', [$tenant, $role])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="slug" value="<?php echo e($role->slug); ?>" disabled readonly>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="<?php echo e(route('superadmin.tenants.roles.permissions.edit', [$tenant, $role])); ?>" class="btn btn-outline-primary mt-2">
...
<?php echo $__env->make('superadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/MYDEV/siar/resources/views/superadmin/tenants/roles/edit.blade.php ENDPATH**/ ?>