...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="work_unit_id" id="work_unit_id" class="form-select <?php $__errorArgs = ['work_unit_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php $__currentLoopData = $workUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($unit->id); ?>" 
                                            ...
                                            <?php echo e(old('work_unit_id', $riskReport->work_unit_id) == $unit->id ? 'selected' : ''); ?>>
                                        <?php echo e($unit->unit_name); ?> <?php echo e($unit->unit_code ? '('.$unit->unit_code.')' : ''); ?>

                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <input type="hidden" name="reporter_unit" id="reporter_unit_name" value="<?php echo e(old('reporter_unit', $riskReport->reporter_unit)); ?>">
            ...
            <div class="card form-section">
                ...
                <div class="card-body">
                    ...
                    <div id="tags-container" class="d-flex flex-wrap gap-1 mb-1">
                        ...
                        ?>
                        <?php $__currentLoopData = $currentTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    const initialTags = <?php echo json_encode($currentTags, 15, 512) ?>;
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', ['hideDefaultHeader' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/01 PAPA/05 DEVELOPMENT/siar/resources/views/modules/RiskManagement/risk-reports/edit.blade.php ENDPATH**/ ?>