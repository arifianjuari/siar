...
unset($__errorArgs, $__bag); ?>" id="role_id" name="role_id" required>
                                ...
                                <option value="1" <?php echo e(old('role_id') == '1' ? 'selected' : ''); ?>>Superadmin</option>
                                <option value="2" <?php echo e(old('role_id') == '2' ? 'selected' : ''); ?>>Tenant Admin</option>
                                <option value="3" <?php echo e(old('role_id') == '3' ? 'selected' : ''); ?>>Manajemen Strategis</option>
                                <option value="4" <?php echo e(old('role_id') == '4' ? 'selected' : ''); ?>>Manajemen Eksekutif</option>
                                <option value="5" <?php echo e(old('role_id') == '5' ? 'selected' : ''); ?>>Manajemen Operasional</option>
                                <option value="6" <?php echo e(old('role_id') == '6' ? 'selected' : ''); ?>>Staf</option>
                            </select>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/01 PAPA/05 DEVELOPMENT/siar/resources/views/roles/superadmin/users/create.blade.php ENDPATH**/ ?>