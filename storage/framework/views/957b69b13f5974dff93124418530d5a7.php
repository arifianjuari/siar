        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <?php if(isset($latestReports) && count($latestReports) > 0): ?>
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e($report->reference_number); ?></td>
                                    <td><?php echo e(Str::limit($report->title, 50)); ?></td>
                                    <td>
                                        <?php
                                            $riskClass = '';
                                            $riskLabel = '';
                                        ...
                                        ?>
                                        <span class="badge <?php echo e($riskClass); ?>"><?php echo e($riskLabel); ?></span>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif($report->status === 'implemented'): ?>
                                            <span class="badge bg-dark">Dijalankan</span>
                                        <?php elseif($report->status === 'monitored'): ?>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('superadmin.risk-management.reports.show', $report->id)); ?>" class="btn btn-sm btn-outline-primary">
                    ...
                    <div class="mt-3">
                        <a href="<?php echo e(route('superadmin.risk-management.reports.index')); ?>" class="btn btn-outline-primary">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <a href="<?php echo e(route('pages.help')); ?>" class="btn btn-outline-primary">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const riskData = {
            ...
            datasets: [{
                ...
                data: [
                    <?php echo e($stats['risk_low'] ?? 0); ?>, 
                    <?php echo e($stats['risk_medium'] ?? 0); ?>, 
                    <?php echo e($stats['risk_high'] ?? 0); ?>, 
                    <?php echo e($stats['risk_extreme'] ?? 0); ?>
        ...
        const corrData = {
            ...
            datasets: [
                {
                    label: 'Surat Masuk',
                    data: <?php echo e(json_encode($stats['corr_incoming'] ?? array_fill(0, 12, 0))); ?>,
                    borderColor: '#3B82F6',
                ...
                {
                    label: 'Surat Keluar',
                    data: <?php echo e(json_encode($stats['corr_outgoing'] ?? array_fill(0, 12, 0))); ?>,
                    borderColor: '#8B5CF6',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/01 PAPA/05 DEVELOPMENT/siar/resources/views/roles/superadmin/dashboard.blade.php ENDPATH**/ ?>