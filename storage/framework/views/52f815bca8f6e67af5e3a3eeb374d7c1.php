...
<?php $__env->startSection('content'); ?>
    <div class="card shadow border-top-0">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h4 class="mb-0 fw-bold text-primary"><i class="fas fa-building me-1"></i> Edit Unit Kerja</h4>
            <a href="<?php echo e(route('tenant.work-units.index')); ?>" class="btn btn-secondary btn-sm">
                <i class="fas fa-arrow-left me-1"></i> Kembali
            </a>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('tenant.work-units.update', $workUnit)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="unit_name" name="unit_name" value="<?php echo e(old('unit_name', $workUnit->unit_name)); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>" id="unit_code" name="unit_code" value="<?php echo e(old('unit_code', $workUnit->unit_code)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="unit_type" name="unit_type" required>
                            ...
                            <option value="medical" <?php echo e(old('unit_type', $workUnit->unit_type) == 'medical' ? 'selected' : ''); ?>>Medical</option>
                            <option value="non-medical" <?php echo e(old('unit_type', $workUnit->unit_type) == 'non-medical' ? 'selected' : ''); ?>>Non-Medical</option>
                            <option value="supporting" <?php echo e(old('unit_type', $workUnit->unit_type) == 'supporting' ? 'selected' : ''); ?>>Supporting</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" id="head_of_unit_id" name="head_of_unit_id" required>
                            ...
                            <?php $__currentLoopData = $users ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>" <?php echo e(old('head_of_unit_id', $workUnit->head_of_unit_id) == $user->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="3"><?php echo e(old('description', $workUnit->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="order" name="order" value="<?php echo e(old('order', $workUnit->order)); ?>">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" <?php echo e(old('is_active', $workUnit->is_active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/MYDEV/siar/resources/views/tenant/work_units/edit.blade.php ENDPATH**/ ?>