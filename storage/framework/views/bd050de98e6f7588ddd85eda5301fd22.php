<?php $__env->startSection('title', 'Tambah SPO Baru'); ?>
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('work-units.spo.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                id="document_title" name="document_title" value="<?php echo e(old('document_title')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $documentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php echo e(old('document_type', $defaultValues['document_type']) == $value ? 'selected' : ''); ?>>
                                            <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    id="document_version" name="document_version" value="<?php echo e(old('document_version', $defaultValues['document_version'])); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                id="document_number" name="document_number" value="<?php echo e(old('document_number', $defaultValues['document_number'])); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                    id="document_date" name="document_date" value="<?php echo e(old('document_date', $defaultValues['document_date'])); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $confidentialityLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php echo e(old('confidentiality_level', $defaultValues['confidentiality_level']) == $value ? 'selected' : ''); ?>>
                                            <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php $__currentLoopData = $workUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workUnit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($workUnit->id); ?>" <?php echo e(old('work_unit_id') == $workUnit->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php $__currentLoopData = $linkedUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($unit->id); ?>" <?php echo e((is_array(old('linked_unit')) && in_array($unit->id, old('linked_unit'))) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                id="file_url" name="file_url" value="<?php echo e(old('file_url')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                id="review_cycle_months" name="review_cycle_months" value="<?php echo e(old('review_cycle_months', $defaultValues['review_cycle_months'])); ?>" min="1" max="60" required>
...
unset($__errorArgs, $__bag); ?>" 
                                id="definition" name="definition" rows="3"><?php echo e(old('definition')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                id="policy" name="policy" rows="3"><?php echo e(old('policy')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                id="procedure" name="procedure" rows="8"><?php echo e(old('procedure')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                id="reference" name="reference" rows="3"><?php echo e(old('reference')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="border-top pt-3">
                    ...
                    <a href="<?php echo e(route('work-units.spo.index')); ?>" class="btn btn-secondary ms-2">
...
<?php echo $__env->make('layouts.app', ['hideDefaultHeader' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/MYDEV/siar/resources/views/modules/work-unit/spo/create.blade.php ENDPATH**/ ?>