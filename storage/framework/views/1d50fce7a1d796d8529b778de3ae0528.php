<?php $__env->startSection('title', ' | Buat Analisis Risiko'); ?>
...
<div class="container-fluid py-4">
    ...
    <form action="<?php echo e(route('modules.risk-management.risk-analysis.store', $report->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="border-bottom pb-3 mb-3">
                            <div class="mb-3">
                                ...
                                <div class="form-control-plaintext fw-bold"><?php echo e($report->document_number); ?></div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label text-muted small mb-1">Judul Risiko</label>
                                <div class="form-control-plaintext fw-bold"><?php echo e($report->document_title); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="border-bottom pb-3 mb-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <div>
                                        <?php if(strtolower($report->risk_level) == 'tinggi' || strtolower($report->risk_level) == 'high'): ?>
                        ...
                        <!-- Lampiran -->
                        <?php if($report->documents && count($report->documents) > 0): ?>
                        <div class="mb-3">
                            <h6 class="text-muted mb-3">LAMPIRAN</h6>
                            <div class="list-group">
                                <?php $__currentLoopData = $report->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('modules.risk-management.risk-reports.download-attachment', [$report->id, $document->id])); ?>" 
                                   class="list-group-item list-group-item-action">
                                    <i class="fas fa-paperclip me-2"></i><?php echo e($document->original_name); ?>
...
unset($__errorArgs, $__bag); ?>" required><?php echo e(old('direct_cause')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" required><?php echo e(old('root_cause')); ?></textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="factor-option form-check">
                                        <input type="checkbox" class="form-check-input" 
                                               ...
                                               <?php echo e(in_array($key, old("contributor_factors.{$category}", [])) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" required><?php echo e(old('recommendation_short')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('recommendation_medium')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('recommendation_long')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="draft" <?php echo e(old('analysis_status') == 'draft' ? 'selected' : ''); ?>>Draft</option>
                                <option value="in_progress" <?php echo e(old('analysis_status') == 'in_progress' || old('analysis_status') == 'reviewed' ? 'selected' : ''); ?>>Ditinjau</option>
                                <option value="completed" <?php echo e(old('analysis_status') == 'completed' ? 'selected' : ''); ?>>Selesai</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <a href="<?php echo e(route('modules.risk-management.risk-reports.show', $report->id)); ?>" class="btn btn-outline-secondary w-100">
                            Batal
                        </a>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/01 PAPA/05 DEVELOPMENT/siar/resources/views/modules/RiskManagement/risk-analysis/create.blade.php ENDPATH**/ ?>