                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['thisMonth'] ?? 0); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo e($stats['draft'] ?? 0); ?></div>
                                </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['pending_review'] ?? 0); ?></div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="<?php echo e(route('modules.correspondence.letters.index')); ?>" class="btn btn-primary btn-icon-split mb-2">
                    ...
                    <a href="<?php echo e(route('modules.correspondence.letters.create')); ?>" class="btn btn-success btn-icon-split mb-2">
                        <span class="icon text-white-50">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <?php if(isset($recentLetters) && $recentLetters->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-sm table-hover">
                                <tbody>
                                <?php $__currentLoopData = $recentLetters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $letter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <a href="<?php echo e(route('modules.correspondence.letters.show', $letter->id)); ?>">
                                                <?php echo e(Str::limit($letter->document_title, 40)); ?>

                                            </a>
                                            <br>
                                            <small class="text-muted">No: <?php echo e($letter->document_number ?? '-'); ?> | <?php echo e($letter->created_at->diffForHumans()); ?></small>
                                        </td>
                                        <td class="text-right">
                                            <span class="badge bg-<?php echo e($letter->status == 'Draft' ? 'secondary' : 'success'); ?>"><?php echo e($letter->status ?? 'Terkirim'); ?></span>
                                        </td>
                                    </tr>
                        ...
                        <div class="text-center mt-2">
                             <a href="<?php echo e(route('modules.correspondence.letters.index')); ?>">Lihat Semua &rarr;</a>
                        </div>
                    <?php else: ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const monthlyTrendData = <?php echo json_encode($chartDataMonthly ?? ['labels' => [], 'data' => []]); ?>;
        const statusDistributionData = <?php echo json_encode($chartDataStatus ?? ['labels' => [], 'data' => [], 'colors' => []]); ?>;
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', ['hideDefaultHeader' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/MYDEV/siar/resources/views/modules/Correspondence/dashboard.blade.php ENDPATH**/ ?>