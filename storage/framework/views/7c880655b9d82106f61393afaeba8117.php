...
unset($__errorArgs, $__bag); ?>" id="tenant_id" name="tenant_id">
                                <option value="">-- Pilih Tenant --</option>
                                <?php $__currentLoopData = $tenants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tenant->id); ?>" <?php echo e((old('tenant_id', $user->tenant_id) == $tenant->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-text">Kosongkan jika pengguna ini adalah Superadmin.</div>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-grid gap-2 mt-4">
                            ...
                            <?php if($user->id !== auth()->id()): ?>
                                <a href="#" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal">
...
<?php echo $__env->make('superadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/MYDEV/siar/resources/views/superadmin/users/edit.blade.php ENDPATH**/ ?>