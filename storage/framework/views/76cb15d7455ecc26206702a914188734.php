            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form id="permission-form" action="<?php echo e(route('superadmin.tenants.roles.permissions.update', [$tenant, $role])); ?>" method="POST">
                        ...
                        <!-- Debug fields -->
                        <input type="hidden" name="debug_form_action" value="<?php echo e(route('superadmin.tenants.roles.permissions.update', [$tenant, $role])); ?>">
                        <input type="hidden" name="debug_tenant_id" value="<?php echo e($tenant->id); ?>">
                        <input type="hidden" name="debug_role_id" value="<?php echo e($role->id); ?>">
                                            ...
                                            <div class="d-flex flex-wrap gap-3">
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input view-permission" 
                                                        ...
                                                        value="1"
                                                        <?php echo e(isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_view ? 'checked' : ''); ?>
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input other-permission" 
                                                        ...
                                                        value="1"
                                                        <?php echo e(isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_create ? 'checked' : ''); ?>

                                                        <?php echo e(isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_view ? '' : 'disabled'); ?>
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input other-permission" 
                                                        ...
                                                        value="1"
                                                        <?php echo e(isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_edit ? 'checked' : ''); ?>
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input other-permission" 
                                                        ...
                                                        value="1"
                                                        <?php echo e(isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_delete ? 'checked' : ''); ?>
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input other-permission" 
                                                        ...
                                                        value="1"
                                                        <?php echo e(isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_export ? 'checked' : ''); ?>
                                                ...
                                                <div class="form-check me-3">
                                                    <input type="checkbox" class="form-check-input other-permission" 
                                                        ...
                                                        value="1"
                                                        <?php echo e(isset($rolePermissions[$module->id]) && $rolePermissions[$module->id]->can_import ? 'checked' : ''); ?>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('superadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/MYDEV/siar/resources/views/superadmin/tenants/roles/permissions.blade.php ENDPATH**/ ?>