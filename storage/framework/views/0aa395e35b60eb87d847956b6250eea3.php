...
<?php $__env->startSection('content'); ?>
    <div class="card shadow border-top-0">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h4 class="mb-0 fw-bold text-primary"><i class="fas fa-edit me-1"></i> Edit Tag</h4>
            <a href="<?php echo e(route('tenant.tags.index')); ?>" class="btn btn-secondary btn-sm">
                <i class="fas fa-arrow-left me-1"></i> Kembali
            </a>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('tenant.tags.update', $tag)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="3"><?php echo e(old('description', $tag->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="parent_id" name="parent_id">
                            ...
                            <?php $__currentLoopData = $parentTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parentTag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($parentTag->id); ?>" <?php echo e(old('parent_id', $tag->parent_id) == $parentTag->id ? 'selected' : ''); ?>><?php echo e($parentTag->name); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="order" name="order" value="<?php echo e(old('order', $tag->order)); ?>" min="0">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/MYDEV/siar/resources/views/tenant/tags/edit.blade.php ENDPATH**/ ?>