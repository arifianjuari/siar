            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control summernote" id="body" name="body" rows="6" required><?php echo e(old('body', $defaultBody)); ?></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="input-group mb-2">
                            <textarea class="form-control" id="reference_to" name="reference_to" rows="3"><?php echo e(old('reference_to')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/01 PAPA/05 DEVELOPMENT/siar/resources/views/modules/Correspondence/letters/create.blade.php ENDPATH**/ ?>