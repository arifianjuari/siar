...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex">
            <a href="<?php echo e(route('modules.risk-management.risk-reports.create')); ?>" class="btn btn-primary me-2">
                <i class="fas fa-plus-circle me-1"></i> Buat Laporan Baru
            </a>
            <a href="<?php echo e(route('modules.risk-management.risk-reports.index')); ?>" class="btn btn-outline-primary">
        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="card kpi-card bg-risk-high">
                <div class="card-body">
                    ...
                    <h2 class="kpi-value"><?php echo e($stats['open']); ?></h2>
        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="card kpi-card bg-risk-medium">
                <div class="card-body">
                    ...
                    <h2 class="kpi-value"><?php echo e($stats['in_review']); ?></h2>
        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="card kpi-card bg-risk-low">
                <div class="card-body">
                    ...
                    <h2 class="kpi-value"><?php echo e($stats['resolved']); ?></h2>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table recent-reports-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="report-row" data-status="<?php echo e($report['status']); ?>">
                            <td class="ps-3 report-title"><?php echo e($report['title']); ?></td>
                            <td><span class="category-badge"><?php echo e($report['category']); ?></span></td>
                            <td>
                            ...
                            <td class="text-end pe-3">
                                <a href="<?php echo e(route('modules.risk-management.risk-reports.show', $report['id'])); ?>" class="btn btn-sm btn-outline-primary">
            ...
            <div class="py-2 text-center border-top">
                <a href="<?php echo e(route('modules.risk-management.risk-reports.index')); ?>" class="text-decoration-none" style="font-size: 0.85rem;">
