...
<head>
    ...
    <title>Laporan Awal Risiko #<?php echo e($riskReport->riskreport_number); ?></title>
    <style>
        body {
...
<body>
    ...
    <table class="info">
        <tr>
            ...
            <td class="value"><?php echo e($riskReport->riskreport_number); ?></td>
        </tr>
        <tr>
            <td>Tanggal Laporan</td>
            <td class="separator">:</td>
            <td class="value"><?php echo e($riskReport->created_at->format('d/m/Y')); ?></td>
        </tr>
        <tr>
            <td>Unit Pelapor</td>
            <td class="separator">:</td>
        ...
        <tr>
            <td>Judul Risiko</td>
            <td class="separator">:</td>
            <td class="value"><?php echo e($riskReport->risk_title); ?></td>
        </tr>
    </table>
    ...
    <div class="footer">
        ...
        <p>Tanggal: <?php echo e($riskReport->created_at->format('d/m/Y H:i')); ?></p>
    </div>
</body>
</html> <?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/MYDEV/siar/resources/views/risk_reports/laporan_awal.blade.php ENDPATH**/ ?>