...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-4">
        <!-- Form Card -->
        <form method="POST" action="<?php echo e(route('modules.risk-management.risk-reports.update', $riskReport->id)); ?>" class="needs-validation" id="riskReportForm" novalidate>
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('risk_title', $riskReport->risk_title)); ?>" required>
