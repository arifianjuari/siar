...
<div class="main-container">
    ...
    <div class="card main-card">
        ...
        <div class="card-header-custom">
            ...
            <form action="<?php echo e(route('modules.correspondence.letters.index')); ?>" method="GET" class="filter-group">
                <div class="input-group">
                    <input type="text" class="form-control search-input" id="search" name="search" placeholder="Judul, nomor, perihal..." value="<?php echo e(request('search')); ?>">
            ...
            <!-- Tombol Buat Surat -->
            <a href="<?php echo e(route('modules.correspondence.letters.create')); ?>" class="btn btn-success btn-buat-surat">
            ...
            <?php else: ?>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $correspondences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $letter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($letter->created_at->format('d/m/Y H:i')); ?></td>
                                    <td><?php echo e($letter->document_number ?? '-'); ?></td>
                                    <td>
                                        <a href="<?php echo e(route('modules.correspondence.letters.show', $letter->id)); ?>" class="font-weight-bold text-dark">
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap" style="gap: 2px;">
                                            <?php $__currentLoopData = $letter->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="badge bg-dark text-white tag-badge" 
                                                     id="tag-item-<?php echo e($tag->id); ?>-<?php echo e($letter->id); ?>"> 
                                                    <span><?php echo e($tag->name); ?></span>
                                                    <button 
                                                        type="button" 
                                                        class="btn-close btn-close-white"
                                                        onclick="hapusTagLangsung(<?php echo e($tag->id); ?>, <?php echo e($letter->id); ?>, 'App\\Models\\Correspondence')"
                                                        aria-label="Close">
                                                    </button>
                                                </div>
                                        ...
                                        <form class="d-flex mt-1" style="gap: 2px;" data-letter-id="<?php echo e($letter->id); ?>">
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap justify-content-center" style="gap: 5px; min-width: 130px;">
                                            <a href="<?php echo e(route('modules.correspondence.letters.show', $letter->id)); ?>" class="btn btn-info action-btn">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            
                                            <a href="<?php echo e(route('modules.correspondence.letters.edit', $letter->id)); ?>" class="btn btn-warning action-btn">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            
                                            <a href="<?php echo e(route('modules.correspondence.letters.export-pdf', $letter->id)); ?>" class="btn btn-primary action-btn">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div class="text-muted">
                        Menampilkan <?php echo e($correspondences->firstItem() ?? 0); ?> - <?php echo e($correspondences->lastItem() ?? 0); ?> dari <?php echo e($correspondences->total()); ?> data
                    </div>
                    <div>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/01 PAPA/05 DEVELOPMENT/siar/resources/views/modules/Correspondence/letters/index.blade.php ENDPATH**/ ?>