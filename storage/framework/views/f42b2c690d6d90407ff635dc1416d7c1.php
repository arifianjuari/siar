<?php $__env->startSection('title', 'Tambah Pengguna Tenant'); ?>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <h2 class="mb-0">Tambah Pengguna Baru untuk <?php echo e($tenant->name); ?></h2>
        ...
        <div class="col-md-8 mx-auto">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="<?php echo e(route('superadmin.tenants.users.store', $tenant)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('roles.superadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/MYDEV/siar/resources/views/roles/superadmin/tenants/users/create.blade.php ENDPATH**/ ?>